...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?php base_url() ?> nosotros" target="_blank">Nosotros</a>
            </li>
            <li class="menu-item hidden"><a href="" target="_blank">Community</a></li>
            <li class="menu-item hidden"><a href="<?php base_url() ?> login" target="_blank">Sesion</a>
            </li>
        </ul>
    </div>
