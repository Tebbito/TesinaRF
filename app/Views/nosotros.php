...
<h1>¿Que es este proyecto?</h1>
    <h4>Nosotros somos GiziSmart un emprendimiento de cultivos hidroponicos automatizados dirigido a las personas sin espacio o tiempo.</h3>
     
    <h2>¿Porque realizaremos este proyecto?</h2>
        <h4>Este proyecto lo realizamos con la idea de resolver una problematica social la cual es la falta de espacio y tiempo para realizar la actividad agricolas, osea la gente que le gusta tener su huarta con sus propias verduras</h4>
            
    <h2>¿De donde surgio esta idea?</h2>
        <h4>Esta idea surgio porque justo estaba llegando la epoco de ir a estudiar a una universidad y casi siempre el espacio en el que habitas no te otorga mucho espacio para tus ectividades o directamente tus labores/educativas no te dejan tiempo.<br> 
            <br> Entonces de ahi salio la idea de hacer cultivos hydroponicos que se pueden hacer en cualquier lado y automatizarlo por el lado de la falta de tiempo.</h4>

    <h2>¿Que materiales utilizaremos?</h2>
        <h4>Los materiales que utilizamos son materiales economiv¿cos ya que queremos que sea un producto accecible para todos, asi que con lo dicho antes los materiales utilizados son:
